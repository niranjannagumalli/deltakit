...
4. Trigger the stable release workflow. On the tagged commit, trigger the "Build, test, and publish stable wheels" on GitHub Actions [here](https://github.com/Deltakit/deltakit/actions/workflows/release.yml). It builds, tests and publishes the artefacts to PyPI and GitHub, and it renders and uploads the documentation to GitHub pages.
